    ...
    const slides = [
      {
        ...
        desc: "왼쪽 메뉴에는 7가지 기능이 있어요. 이 사용설명서는 PPT처럼 옆으로 넘겨보면서 기능 하나하나를 확인할 수 있게 만들었어요. 위쪽 탭을 클릭하거나, 양옆 화살표 버튼, 키보드 ← → 방향키, 화면 스와이프로도 넘길 수 있어요.",
        intro: true,
        chips: [
      ...
      },
      {
        ...
        features: [
          ...
          "면담 필요 알림 — 면담이 필요한 상담사를 놓치지 않도록 알려줘요.",
      ...
      },
      {
        ...
        features: [
          "상담사 정보를 등록하고 검색·필터링할 수 있어요 (재직 상태 · 업무 구분 · 조 등).",
          "정렬 기준을 바꾸거나, '사용자 지정' 정렬에서는 직접 드래그해서 순서를 바꿀 수 있어요.",
          "상담사를 클릭하면 상세 정보와 면담 이력을 함께 확인할 수 있어요.",
      ...
      },
      {
        ...
        features: [
          "새 메모를 작성하고 폴더별로 분류해서 관리해요.",
          "중요한 메모는 최대 5개까지 화면 상단에 고정할 수 있어요.",
          "제목 수정, 삭제, 폴더 이동이 자유로워요.",
        ],
      },
      {
        key: "interviews",
        ...
        features: [
          "상담사별 면담 기록을 추가·수정·삭제할 수 있어요.",
          "면담 유형이나 검색어로 필요한 기록만 걸러볼 수 있어요.",
      ...
      },
      {
        ...
        features: [
          ...
          "일괄 붙여넣기로 여러 인원의 스케줄을 한 번에 입력할 수 있어요.",
          "셀을 드래그해서 여러 칸을 한 번에 선택한 뒤, 메뉴에서 상태를 골라 한 번에 적용할 수 있어요.",
          "이미지로 저장하거나 엑셀 파일로 다운로드할 수 있어요.",
          "셀을 클릭하면 근무/오프/연차 등 다양한 상태로 바로 바꿀 수 있어요. 지각은 출근 인원에 포함, 결근은 제외돼요.",
